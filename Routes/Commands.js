...
const theConsulat = require("../Middlewares/Specials/consulat");
...
router.put('/:idCommand/accept', limits(200, 15), existCommand, authRestaurant, commandCtrl.acceptCommand, /* theConsulat */); 
